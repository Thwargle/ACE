...
foreach ($subdirectory in @('Source', 'Plugins\ACEClient\Source', 'Plugins\ACEClient\Docs\UI\Resolved', 'Plugins\ACEClient\Tests\Fixtures', 'Plugins\ProceduralMeshComponent\Source', 'Content\ACE\RuntimeMaterials')) {
