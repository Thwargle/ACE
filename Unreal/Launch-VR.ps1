...
$project = Join-Path $PSScriptRoot 'ACEViewer.uproject'
...
& "$engine/Build/BatchFiles/Build.bat" ACEViewerEditor Win64 Development "-Project=$project" -WaitMutex -NoHotReloadFromIDE -gather
