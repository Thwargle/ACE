...
set PROJECT=%~dp0ACUnreal.uproject
...
echo Building ACUnrealEditor if needed...
call "%UE_ROOT%\Engine\Build\BatchFiles\Build.bat" ACUnrealEditor Win64 Development -Project="%PROJECT%" -WaitMutex
