...
#include "ACEViewerGameMode.generated.h"

class UACEWorldPresenterComponent;
class UACETerrainPresenterComponent;

/**
 * Default game mode for ACEViewer: ACEPlayerController + world/terrain presenters.
 * Press Play → login UI → Enter World.
 */
UCLASS()
class ACEVIEWER_API AACEViewerGameMode : public AGameModeBase
{
	GENERATED_BODY()
