...
{
	inline constexpr int32 ReleaseNumber = 78;
...
#if PLATFORM_ANDROID
	inline constexpr const TCHAR* Version = TEXT("2026.09.25.quest.78");
#else
	inline constexpr const TCHAR* Version = TEXT("2026.09.25.84");
#endif
}
